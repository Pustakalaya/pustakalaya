    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='audio.Audio', verbose_name='Link')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='audio',
            name='audio_genre',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='audio.AudioGenre', verbose_name='Audio Genre'),
        ),
        migrations.AddField(
            model_name='audio',
            name='audio_read_by',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='core.Biography', verbose_name='Read / Voice by'),
        ),
        migrations.AddField(
            model_name='audio',
            name='audio_series',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='audio.AudioSeries', verbose_name='Audio Series / Volume'),
        ),
        migrations.AddField(
            model_name='audio',
            name='audio_type',
            field=models.ManyToManyField(to='audio.AudioType', verbose_name='Audio type'),
        ),
        migrations.AddField(
            model_name='audio',
            name='collection',
